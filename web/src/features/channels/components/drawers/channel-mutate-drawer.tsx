...
import { invalidateModelCapabilityQueries } from '@/features/models/lib/model-capability-query-invalidation'
                              ...
                              <div className='divide-border space-y-0 divide-y border-y'>
                                ...
                                {(currentType === 1 || currentType === 57) && (
                                  <>
                                    ...
                                    <FormField
                                      control={form.control}
                                      name='force_image_b64_json_no_url'
                                      render={({ field }) => (
                                        <FormItem className='flex items-center justify-between gap-3 px-4 py-3'>
                                          <div className='space-y-0.5'>
                                            <FormLabel className='text-sm'>
                                              {t('Hide image response URLs')}
                                            </FormLabel>
                                            <FormDescription>
                                              {t(
                                                'Force b64_json for image generation and edits, then remove url fields from image responses'
                                              )}
                                            </FormDescription>
                                          </div>
                                          <FormControl>
