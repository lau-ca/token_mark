...
const DocumentRenderer = ({ apiEndpoint, title, cacheKey, emptyMessage }) => {
  ...
  if (!content || content.trim() === '') {
    return (
      <div className='document-page flex justify-center items-center min-h-screen'>
        <Empty
  ...
  if (isUrl(content)) {
    return (
      <div className='document-page flex justify-center items-center min-h-screen p-4'>
        <Card className='document-card max-w-md w-full'>
          <div className='text-center'>
            <Title heading={4} className='mb-4'>
              {title}
            </Title>
            <p className='document-muted mb-4'>
    ...
    return (
      <div className='document-page min-h-screen'>
        <div className='max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8'>
          <div className='document-card rounded-lg shadow-sm p-8'>
