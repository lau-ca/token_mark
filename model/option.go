...
func InitOptionMap() {
	...
	common.OptionMap["CompositeGroupRoutingEnabled"] = strconv.FormatBool(setting.CompositeGroupRoutingEnabled)
	...
	common.OptionMap["PublicApiBaseUrl"] = system_setting.PublicApiBaseUrl
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" || key == "SMTPInsecureSkipVerify" {
		...
		case "CompositeGroupRoutingEnabled":
			setting.CompositeGroupRoutingEnabled = boolValue
		case "TaskEnabled":
	...
	case "PublicApiBaseUrl":
		system_setting.PublicApiBaseUrl = value
	case "WorkerUrl":
