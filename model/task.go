...
type TaskBillingContext struct {
	...
	PerCallBilling        bool                         `json:"per_call_billing,omitempty"`        // 提交时已确定最终费用
	TieredBillingSnapshot *billingexpr.BillingSnapshot `json:"tiered_billing_snapshot,omitempty"` // 表达式计费冻结快照
