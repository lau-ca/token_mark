...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/update_health", permission: authz.ChannelOperate, handler: controller.UpdateAllChannelsHealth},
	{method: http.MethodGet, path: "/update_health/:id", permission: authz.ChannelOperate, handler: controller.UpdateChannelHealth},
	...
	{method: http.MethodPut, path: "/:id/pricing", permission: authz.ChannelWrite, handler: controller.UpdateChannelPricing},
	...
	{method: http.MethodPost, path: "/:id/qianfan/elements", permission: authz.ChannelSensitiveWrite, handler: controller.CreateQianfanElement},
	{method: http.MethodGet, path: "/:id/qianfan/elements", permission: authz.ChannelRead, handler: controller.ListQianfanElements},
	{method: http.MethodPost, path: "/:id/qianfan/voices", permission: authz.ChannelSensitiveWrite, handler: controller.CreateQianfanVoice},
	{method: http.MethodGet, path: "/:id/qianfan/voices", permission: authz.ChannelRead, handler: controller.ListQianfanVoices},
	{method: http.MethodGet, path: "/:id/qianfan/voices/presets", permission: authz.ChannelRead, handler: controller.ListQianfanPresetVoices},
	{method: http.MethodGet, path: "/:id/qianfan/voices/tasks/:task_id", permission: authz.ChannelRead, handler: controller.GetQianfanVoiceTask},
	{method: http.MethodDelete, path: "/:id/qianfan/voices/:voice_id", permission: authz.ChannelSensitiveWrite, handler: controller.DeleteQianfanVoice},
