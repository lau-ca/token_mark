...
func (c *ImagePromptParameterAppendConfig) MatchesModel(string) bool { return c != nil && c.Enabled }
func (c *ImagePromptParameterAppendConfig) Append(prompt, _, _ string) (string, bool, error) {
	return prompt, false, nil
}

func (c *ImagePromptParameterAppendConfig) Validate() error { return nil }
func (s *ChannelSettings) ValidateRetryTimes() error        { return nil }
